...
from evolution import Level, Mt19937, Planting, Previews, load_level, load_plants, parse_cell, scenario, search_recipe, tile_kinds
...
class Rank4Test(unittest.TestCase):
    ...
    def test_ten_captured_activations(self):
        for case in CASES:
